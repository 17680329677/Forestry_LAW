...
in_file_name = "E:\\ltp_data_v3.4.0\\input.txt"
out_file_name = "E:\\ltp_data_v3.4.0\\output.txt"
begin_line = 1
end_line = 0
...
def extraction_start(in_file_name, out_file_name, begin_line, end_line):
    ...
    Args:
        ...
        end_line: 读文件的结束行
    """
    in_file = open(in_file_name, 'r', encoding='gbk', errors='ignore')
...
if __name__ == "__main__":
    ...
    in_file_name = "C:\\Users\\dhz1216\\Desktop\\test\\law_input.txt"
    out_file_name = "C:\\Users\\dhz1216\\Desktop\\test\\law_output.txt"
    # extraction_start(in_file_name, out_file_name, begin_line, end_line)
    extraction_start(in_file_name, out_file_name, begin_line, end_line)
